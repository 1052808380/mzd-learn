package org.mzd.zookeeper.aspectj;
...
import org.mzd.zookeeper.annotation.LockKeyParam;
import org.mzd.zookeeper.annotation.ZooLock;
...
public class ZooLockAspect {
     ...
     * 切入点
     */
    @Pointcut("@annotation(org.mzd.zookeeper.annotation.ZooLock)")
    public void doLock() {
