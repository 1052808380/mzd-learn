...
public class ConfiguratorTest {
     ...
     * Configurator整合在一起。
     *
     * {@link LoggerRepository}:LoggerRepository是一个Logger的容器，它负责创建、缓存Logger
     ...
     * 法和属性。
     *
     * {@link Hierarchy}:Hierarchy是Log4J中默认对LoggerRepository的实现类，它用于表达其内部的Logger
     ...
     *
     * {@link Hierarchy#getLogger(String, LoggerFactory)}
